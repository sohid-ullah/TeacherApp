...
namespace TeacherApp.Data
{
        ...
        : class, IEntity<TKey>
    {
        ...
        public Repository(DbContext dbContext)
        {
            ...
            _dbSet = _dbContext.Set<TEntity>(); //is it returning only a dbset. like as Course
        }
        ...
        public virtual int GetCount(Expression<Func<TEntity, bool>> filter = null) //why null
        {
